...
#files = nanoGetSampleFiles(mcDirectory, 'tZq_ll') ### FIXME MISSING SAMPLE
#samples['tZq'] = {
#    'name': files,
#    'weight': mcCommonWeight,
#    'FilesPerJob': 4
...
#        nanoGetSampleFiles(mcDirectory, 'DYJetsToLL_M-10to50-LO') ### FIXME MISSING SAMPLE
samples['DY'] = {
    'name': files,
...
samples =  {k:v for k,v in samples.items() if k in ['WW']}
