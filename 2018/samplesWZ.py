...
#samples =  {k:v for k,v in samples.items() if 'DY' in k}
#samples = {k:v for k,v in samples.items() if 'sm' not in k and 'lin' not in k and 'quad' not in k and 'DY' not in k} # SM ONLY
